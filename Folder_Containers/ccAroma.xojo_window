#tag DesktopWindow
Begin DesktopContainer ccAroma
   ...
   Begin DesktopLabel LabelShare
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "#Module_Multilanguage.kRecommendedMixingRatio"
      TextAlignment   =   0
      TextColor       =   &c00000000
      Tooltip         =   ""
      Top             =   53
      ...
      Width           =   308
   End
   Begin DesktopTextField txtRatio
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
      AllowSpellChecking=   False
      AllowTabs       =   False
      ...
      Width           =   100
   End
   Begin DesktopLabel LabelRipeTime
      AllowAutoDeactivate=   True
      Bold            =   False
      Enabled         =   True
      FontName        =   "System"
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "#Module_Multilanguage.kRipeTime"
      TextAlignment   =   0
      TextColor       =   &c00000000
      Tooltip         =   ""
      Top             =   85
...
#tag WindowCode
	#tag Method, Flags = &h0
		Sub Clear()
		  ...
		  txtRatio.Text = Format( 0, "#.00" )
		  txtRipeTime.Text = Format( 0, "#.00" )
		  txtDescription.Text = ""
	...
	#tag Method, Flags = &h0
		Sub LoadAroma(dbID As Integer)
		  UIState(False)
		  
		  Aroma = New Class_Aroma( dbID )
		  
		  If Aroma.ID > -1 Then
		    
		    txtName.Text = Aroma.Name
		    txtRatio.Text = Aroma.MixingRatio
		    txtRipeTime.Text = Aroma.RipeTime
		    txtDescription.Text = Aroma.Description
		    rtgRating.Rating = Aroma.Rating
		    
		    ppmDealer.ListIndexFromRowTag( Aroma.Dealer.Dealer )
	...
	#tag Method, Flags = &h21
		Private Sub UIState(EnableAll As Boolean)
		  ...
		  txtRatio.Enabled = EnableAll
		  txtRipeTime.Enabled = EnableAll
...
#tag Events cnvImage
	#tag Event
		Sub Paint(g As Graphics, areas() As Rect)
		  ...
		  If Aroma <> Nil And Aroma.Logo <> Nil Then
		    
		    g.ScaleToFit(Aroma.Logo)
...
#tag Events btnDelete
	#tag Event
		Function MouseDown(x As Integer, y As Integer) As Boolean
		  ...
		  If Aroma = Nil Or Aroma.Logo = Nil Then Return False
		...
		Function KeyDown(key As String) As Boolean
		  If Me.Enabled Then
		    ...
		    If endEditKeys.IndexOf(key) > -1 Then
		      ...
		      Aroma.Description = txtDescription.Text.Trim
...
#tag Events ppmDealer
	#tag Event
		Sub SelectionChanged(item As DesktopMenuItem)
		  ...
		  If Aroma = Nil Or Aroma.ID < 0 Then Return
		  
		  If Me.Enabled Then
		    
		    If Me.SelectedRowIndex > 0 Then
		      
		      Aroma.Dealer.Dealer = Me.RowTagAt(Me.SelectedRowIndex).IntegerValue
...
#tag Events txtRatio
	#tag Event
		Function KeyDown(key As String) As Boolean
		  If Aroma = Nil Then Return False
		  ...
		  If Me.Enabled Then
		    ...
		    If endEditKeys.IndexOf(key) > -1 Then
		      ...
		      Aroma.MixingRatio = txtRatio.Text.Trim
		...
		Function KeyDown(key As String) As Boolean
		  ...
		  If Me.Enabled Then
		    ...
		    If endEditKeys.IndexOf(key) > -1 Then
		      ...
		      Aroma.RipeTime = txtRipeTime.Text.Trim
...
#tag Events rtgRating
	#tag Event
		Sub objectImageSelected(imageValue as Integer)
		  #pragma unused imageValue
		  
		  If Aroma = Nil Or Aroma.ID < 0 Then Return
		  
		  If Me.Enabled Then
		    
		    Aroma.Rating = imageValue
